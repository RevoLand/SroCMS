<div class="dropdown text-sans-serif">
	...
	<div class="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="dt_dropdown-{{ $id }}">
		<div class="bg-white py-2">
			<a class="dropdown-item" href="{{ route('admin.tickets.show', $id) }}">View</a>
            <a class="dropdown-item" href="{{ route('admin.tickets.edit', $id) }}">Edit</a>
            ...
            {!! Form::close() !!}
            <div class="dropdown-divider"></div>
            {!! Form::open([ 'route' => ['admin.tickets.destroy', $id], 'method' => 'delete', 'data-action' => 'delete', 'data-id' => $id ]) !!}

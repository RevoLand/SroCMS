...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="url_user_name" v-model="form.url_user_name" required>
    <span class="fs--1 text-monospace">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="callback_secret" v-model="form.callback_secret" v-show="form.generate_callback_secret == 0">
    <div class="custom-control custom-checkbox">
        <input id="generate_callback_secret" type="checkbox" true-value="1" false-value="0" class="custom-control-input" v-model="form.generate_callback_secret">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="callback_user_name" v-model="form.callback_user_name" required>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="callback_success_name" v-model="form.callback_success_name">
    <span class="fs--1 text-monospace">
...
<div class="form-group">
    ...
    <input type="number" class="form-control" id="minutes_between_votes" v-model="form.minutes_between_votes" required>

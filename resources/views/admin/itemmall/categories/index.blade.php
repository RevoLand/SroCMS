...
@section('pagetitle', 'Web Item Mall Categories')
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Web Item Mall Categories</h3>
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{ route('admin.itemmall.categories.index') }}" class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Categories</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="kt-portlet__head">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('admin.itemmall.categories.create') }}" class="btn btn-primary btn-upper btn-sm btn-bold">
            ...
            swal.fire({ title: 'Are you sure?',
                ...
                confirmButtonText: 'Yes, delete it!'
                    ...
                    if (result.value) {
                        ...
                        .then(response => {
                            $('#itemmallcategories-table').DataTable().draw(false);
                            swal.fire({

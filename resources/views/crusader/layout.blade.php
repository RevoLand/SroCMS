        ...
        <section id="wrapper">
            ...
            <div id="main">
                <aside id="left">
                    ...
                    @else
                    <a href="{{ route('users.register_form') }}" id="register_banner">
                        <p>Create Account</p>
                    </a>
                    @endif
            ...
            <footer>
                <h3>{{ setting('site.title', 'SroCMS') }} &copy; Copyright 2019 </h3>
                <a href="http://evil.duloclan.com" id="evil-logo" target="_blank"
                    title="Design by EvilSystem"><span>Design by EvilSystem</span></a>

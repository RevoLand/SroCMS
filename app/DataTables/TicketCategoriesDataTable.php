...
class TicketCategoriesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('enabled', function (TicketCategory $category)
            {
                if ($category->enabled)
                {
            ...
            ->editColumn('updated_at', function (TicketCategory $category)
            {
            ...
            ->setRowId('id')
            ->rawColumns(['actions', 'enabled', 'created_at', 'updated_at']);
    }

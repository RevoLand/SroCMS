...
class ArticleCategoriesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('enabled', function (ArticleCategory $category)
            {
                if ($category->enabled)
                {
            ...
            ->editColumn('created_at', function (ArticleCategory $category)
            {
            ...
            ->editColumn('updated_at', function (ArticleCategory $category)
            {
            ...
            ->rawColumns(['enabled', 'action', 'created_at', 'updated_at'])
            ->setRowId('id');
    }
